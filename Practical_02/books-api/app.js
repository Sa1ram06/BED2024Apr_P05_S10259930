...
app.get('/books/:id',(req,res) =>{
    const bookId = Number(req.params.id) // Retrieve the id from URL
    const book = books.find(book => book.id == bookId); // Find the book from the array
...
app.put('/books/:id',(req,res) => {
    const bookId = Number(req.params.id) // Retrieve the id from URL
    const bookIndex = books.find(book => book.id == bookId); // Find the book from the array
